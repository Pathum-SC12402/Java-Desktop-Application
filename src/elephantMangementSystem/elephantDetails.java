...
public class elephantDetails extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Enter the Elephant id");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Elephant id", "Name", "Sex", "Height", "Weight", "Hard id", "Date of Birth", "Place of Birth", "Training info"
            }
        ) {
        ...
        jTable1.setPreferredSize(new java.awt.Dimension(550, 700));
        jScrollPane1.setViewportView(jTable1);

        enter1.setBackground(new java.awt.Color(0, 105, 68));
        enter1.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(elephantDetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new elephantDetails().setVisible(true);
            }
        });
    }
